...
const ForgetPassword = () => {
	...
	return (
		<SafeAreaView className="h-full px-5">
			<GoBack />
			<View className="mt-4">
				<Text className="text-2xl font-medium text-primary-100 text-center">Set new password</Text>
				<Text className="text-tertiary-400 text-center mt-2">Set your new password</Text>
			</View>
			...
			<PrimaryBtn fn={() => router.push('/login')} text="Save" additionalStyle="mt-auto mb-20" />
